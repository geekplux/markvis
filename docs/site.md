...
`/examples` is generated from `examples/valid/*.md` plus `examples/out/<stem>.svg` so docs cannot drift. Today: 86 valid files. Invalid fixtures stay off the gallery.
