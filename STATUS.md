...
## Snapshot
- Site chrome: Klein Blue schema in VitePress (no peach/Motions yellow); Klein square logo (white M, cyan V); Docs sidebar in rails; mobile Menu drawer 44px; play two panes iframe
...
## Commands
# site chrome: Klein Blue schema + square M/V mark; Docs rails (no clip); Menu in right cluster
