...
describe("check", () => {
  ...
  it("exits 0 for examples/valid", () => {
    ...
    expect(oks).toHaveLength(88);
    expect(stderr).toContain("88 ok");
  ...
  it("exits non-zero for examples/invalid", () => {
    ...
    expect(stderr).toContain("39 error");
  });
...
describe("gallery", () => {
  ...
  it("writes HTML catalog from examples/out", () => {
    ...
    expect(html).toContain("88 charts from SVG snapshots");
  ...
  it("matches committed examples/gallery.html", () => {
    ...
    expect(committed).toContain("88 charts from SVG snapshots");
  });
