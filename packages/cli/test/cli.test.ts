...
describe("check", () => {
  ...
  it("exits 0 for examples/valid", () => {
    ...
    expect(oks).toHaveLength(63);
    expect(stderr).toContain("63 ok");
  ...
  it("exits non-zero for examples/invalid", () => {
    ...
    expect(stderr).toContain("30 error");
  });
...
describe("gallery", () => {
  ...
  it("writes HTML catalog from examples/out", () => {
    ...
    expect(html).toContain("63 charts from SVG snapshots");
  ...
  it("matches committed examples/gallery.html", () => {
    ...
    expect(committed).toContain("63 charts from SVG snapshots");
  });
