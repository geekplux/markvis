...
describe("check", () => {
  ...
  it("exits 0 for examples/valid", () => {
    ...
    expect(oks).toHaveLength(86);
    expect(stderr).toContain("86 ok");
...
describe("gallery", () => {
  ...
  it("writes HTML catalog from examples/out", () => {
    ...
    expect(html).toContain("86 charts from SVG snapshots");
    ...
    expect(html).toContain("<figcaption>58-pie-donut.svg</figcaption>");
    expect(html).toContain("<svg ");
    expect(html).toContain("</svg>");
  ...
  it("matches committed examples/gallery.html", () => {
    ...
    expect(committed).toContain("86 charts from SVG snapshots");
  });
