...
describe("check", () => {
  ...
  it("exits 0 for examples/valid", () => {
    ...
    expect(oks).toHaveLength(58);
    expect(stderr).toContain("58 ok");
  ...
  it("exits non-zero for examples/invalid", () => {
    ...
    expect(stderr).toContain("25 error");
  });
...
describe("gallery", () => {
  ...
  it("writes HTML catalog from examples/out", () => {
    ...
    expect(html).toContain("58 charts from SVG snapshots");
  ...
  it("matches committed examples/gallery.html", () => {
    ...
    expect(committed).toContain("58 charts from SVG snapshots");
  });
