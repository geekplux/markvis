...
describe("check", () => {
  ...
  it("exits 0 for examples/valid", () => {
    ...
    expect(oks).toHaveLength(87);
    expect(stderr).toContain("87 ok");
...
describe("gallery", () => {
  ...
  it("writes HTML catalog from examples/out", () => {
    ...
    expect(html).toContain("87 charts from SVG snapshots");
  ...
  it("matches committed examples/gallery.html", () => {
    ...
    expect(committed).toContain("87 charts from SVG snapshots");
  });
